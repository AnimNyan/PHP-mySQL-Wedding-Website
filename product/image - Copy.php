...
if (!isset($_SESSION['user_id'])) {
    ...
    if ($user_stmt->execute([$_SESSION['user_id']]) && $user_stmt->rowCount() == 1) {
        ...
        <form method="post">
                <input type="submit" value="Delete the chosen images">
                <table border="1" cellpadding="3">
                    <tr>
                        <th>Delete</th>
                        <th>image</th>
                        ...
                        <tr>
                            <td style="text-align: center">
                                <input type="checkbox" name="delt[]" value="test" >
                            </td>
                            <td><img src="../product_images/5f8d2901abc67_Capture.GIF" alt="" width="25vw"></td>
                            <td style="text-align: center">
                                <input type="checkbox" name="delt[]" value="test" >
                            </td>
                            <td><img src="../product_images/5f8d27b41e7c5_heart-529607_640.jpeg" alt="" width="25vw"></td>
                            <td style="text-align: center">
                                <input type="checkbox" name="delt[]" value="test" >
                            </td>
                            <td><img src="../product_images/5f8d251b581b5DSCN3080.JPG" alt="" width="25vw"></td>
                        </tr>
